...
void Pathfinder::help1()
{
	std::cout << "help1" << std::endl;
} 

template <size_t ROW, size_t COL>
void Pathfinder::help(const array<array<int,COL>, ROW>& grid, const Pair& src, const Pair& dest)
{
	std::cout << "hallo " << grid[0][0] << " " << src.first << " " << dest.second << std::endl;
}
template void Pathfinder::help<60, 60>(const array<array<int, 60>, 60>& grid, const Pair& src, const Pair& dest);

template <size_t ROW, size_t COL>
bool Pathfinder::isValid<ROW, COL>(const array<array<int, COL>, ROW>& grid,
	const Pair& point)
...
bool Pathfinder::isDestination(const Pair& position, const Pair& dest)
{
...
template <size_t ROW, size_t COL>
double Pathfinder::calculateGValue<ROW, COL>(const array<array<int, COL>, ROW>& grid, const Pair& position, const Pair& neighbor)
{
	double distance;
	if (position.first != neighbor.first && position.second != position.second)
		distance = s_diagonal;
	else
		distance = 1;
...
//
double Pathfinder::calculateHValue(const Pair& src, const Pair& dest)
{
...
template <size_t ROW, size_t COL>
void Pathfinder::tracePath<ROW, COL>(
...
//
//template <size_t ROW, size_t COL>
//void Pathfinder::aStarSearch<ROW, COL>(const array<array<int, COL>, ROW>& grid,
